...
const MediaKit = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Media Kit - Downloads & Press Resources | Mr. Prabhakar Dwivedi</title>
        <meta name="description" content="Download professional profile, media assets, and press resources for Mr. Prabhakar Dwivedi. High-resolution photos, biography, and credentials available." />
      </Helmet>
